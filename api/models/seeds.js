...
// default value should be false as thats safer for newcomer seeders
const yesIHaveUpdatedTheObjectIdsWithMyOwn = false
// Once you run this once and have the instrument classes created in 
// your mongo database, you need to query your database to retrieve 
// their respective object ids and then update the values in this file 
// to reflect your own, only then can you change this value to true and 
// rerun your seed command.

if (!yesIHaveUpdatedTheObjectIdsWithMyOwn){
  ...
  .then((instrumentsClasses) => {
    console.log('Created InstrumentClasses:', instrumentsClasses)
  ...
  Instrument.create([
    {
      ...
      instrumentClassId: "5a62fe47ae0817bbda3dfe3e"
      // instrument class is altimeter
    },
    {
    ...
    },
    {
      ...
      instrumentClassId: "5a62fe47ae0817bbda3dfe3f"
      //instrument class is airspeed indicator
    },
    {
    ...
    },
    {
      ...
      instrumentClassId: "5a62fe47ae0817bbda3dfe40"
      //instrument class is attitude indicator
    },
    {
    ...
    {
      name: 'Vertical Speed Inidicator with M INCH Round Bezel',
      brand: 'Belite',
      partNo: '10-04351',
      ...
      instrumentClassId: "5a62fe47ae0817bbda3dfe41"
      // instrument class is vertical speed indicator
    },
    {
      name: 'Vertical Speed Indicator',
      brand: 'Falcon',
