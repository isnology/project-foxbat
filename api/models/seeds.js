  ...
  Instrument.create([
    {
      ...
      InstrumentClassId: altimeter[0]._id
    },
    {
  ...
  Instrument.create([
    {
      ...
      InstrumentClassId: airSpeedIndicator[0]._id
    },
    {
  ...
  Instrument.create([
    {
      ...
      InstrumentClassId: attitudeIndicator[0]._id
    },
    {
  ...
  Instrument.create([
    {
      ...
      InstrumentClassId: verticalSpeedIndicator[0]._id
    },
    {
